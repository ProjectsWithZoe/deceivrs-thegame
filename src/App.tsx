...
import { Users, Skull, Target, Crown, Italic } from "lucide-react";
...
const getRandomDeceivers = (players: Array<{name: string, phone: string}>, numDeceivers: number) => {
  ...
  <ul className="list-disc">
    <li>Enter the Name and phone numbers of everyone playing. The game can begin when a <em> minimum of 5 players </em> are entered and <em className="italic text-red-400">Start Game</em> is clicked.</li>
    <li>Deceivrs and loyals will be chosen at random.</li>
    ...
    <li>Suspected Deceivrs are voted out by the majority vote.</li>
    <li>Once a player is voted out, they must declare truthfully if they are a Deceivr or Loyal.</li>
    <li>The game ends when theres a unanimous vote to end it.</li>
    <li>If any deceivrs are left at the end, the deceivrs win.</li>
    <li>If all deceivrs are voted out, the loyals win.</li>
